...
import CoreEventsSync from "../../core/events/sync.js";
...
// TODO: Determine if we need this plugin anymore.
/**
 ...
 * ```
 */
class PingEncryptionPluginSync extends Plugin<(typeof CoreEventsSync)["afterPingCollection"]> {
  /**
  ...
  constructor(private jwk: JWK) {
    super(CoreEventsSync["afterPingCollection"].name, "pingEncryptionPlugin");
  }
...
export default PingEncryptionPluginSync;
