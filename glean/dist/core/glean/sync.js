...
(function (DebugOption) {
    DebugOption["DebugTag"] = "DebugTag";
    DebugOption["SourceTags"] = "SourceTags";
    DebugOption["LogPings"] = "LogPings";
})(DebugOption || (DebugOption = {}));
const setDebugOptionInSessionStorage = (option, value) => {
...
const getDebugOptionFromSessionStorage = (option) => {
...
(function (Glean) {
    ...
    function initializeCoreMetrics(migrateFromLegacy) {
    ...
    function initialize(applicationId, uploadEnabled, config) {
        ...
        if (uploadEnabled) {
            ...
            onUploadEnabled();
            initializeCoreMetrics(config === null || config === void 0 ? void 0 : config.migrateFromLegacyStorage);
        }
        else {
